...
```text
/xxd-panel-081 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，081 设计在下）
2. 左右对照（原图在左，081 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-081/<fresh-task>/
...
- `references/xxd-panel-081-prompt.zh-CN.md`
- `references/xxd-panel-081-prompt.en.md`
