...
# 🦁 XXD Panel 081｜ألبوم ذكريات بالخيوط الملونة

### يحوّل الصورة إلى ملصق تذكاري شخصي بخط أحادي ملوّن وألوان طباعة محدودة
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 081 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.
...
يرمز **Panel 081** الذاكرة بخط أحادي ملوّن متساوي السماكة ومحيطات مفتوحة وانقطاعات وتدرّج كثافة، ثم يستخدم 2–4 ألوان خاصة من الصورة مع حبيبات وانزياح ريزوغراف لصنع مطبوعة تذكارية شخصية.

### مناسب لـ

- تحويل الصورة إلى أطلس تذكاري شخصي لا يحتفظ إلا بالأشخاص والأماكن والأشياء والعلاقات الجديرة بالتذكر؛
- تجنّب الكرتون ذي المحيط الأسود وجعل 2–4 خطوط بألوان خاصة من الأصل تحمل المحيط والبنية وتسلسل المعلومات؛
- بناء نظام تحريري وفراغ عاطفي بالمحيطات المفتوحة وكثافة الخط والتكوين اللامتناظر والورق الأبيض الدافئ الواسع؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 081 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** خط أحادي متساوي السماكة · ترميز بالخطوط الملونة · تدرّج كثافة الخط · 2–4 ألوان خاصة · حبيبات ريزوغراف · سرد تذكاري شخصي
...
توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-081-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 081. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-081 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-081 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-081 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-081 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-081 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 081 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-081 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-081`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-081-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-081-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ81 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 081 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–081) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
